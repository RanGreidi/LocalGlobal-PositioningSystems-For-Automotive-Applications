classdef Map < handle
    ...
    methods
        ...
        function dynamicTrafficPlot(obj)
            ...
            positionArray_x = compose("%4.1f", string(allVehiclePositions(:,1))).';
            positionArray_y = compose("%4.1f", string(-allVehiclePositions(:,3))).';
            nameArray = "V" + [obj.Vehicles.id];
            textDescArray = num2cell([nameArray; positionArray_x; positionArray_y],1)';
